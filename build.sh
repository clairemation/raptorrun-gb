...
[ $? -eq 0 ] || exit 1
rgblink --dmg --map dist/raptorrun.map --sym dist/raptorrun.sym -o dist/raptorrun.gb build/main.o build/game.o build/level.o build/utils.o build/graphicsdata.o build/interrupts.o build/player.o build/bouncers.o build/titlescreen.o build/fadescreen.o build/graphics.o build/text.o
[ $? -eq 0 ] || exit 1
