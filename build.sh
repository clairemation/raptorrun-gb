...
[ $? -eq 0 ] || exit 1
rgblink --dmg --map dist/raptorrun.map --sym dist/raptorrun.sym -o dist/raptorrun.gb build/main.o build/update.o build/graphicsdata.o build/interrupts.o build/player.o build/bouncers.o
[ $? -eq 0 ] || exit 1
