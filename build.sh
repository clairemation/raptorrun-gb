...
[ $? -eq 0 ] || exit 1
rgblink --dmg --tiny --map dist/raptorrun.map --sym dist/raptorrun.sym -o dist/raptorrun.gb build/main.o build/update.o build/graphicsdata.o build/interrupts.o build/player.o
[ $? -eq 0 ] || exit 1
